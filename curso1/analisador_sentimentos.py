...
def analisador_sentimentos(produto):
    propmt_sistema = f"""
    Você é um analisador de sentimentos de acaliações de produtos.
    Escreva um parágrafo com até 50 palavras resuminho as avaliações e
    depois atribua qual o sentimento geral para o produto.
    Identifica também 3 pontos fortes e 3 pontos fracos identificados a partir das avaliações.
