...
def selecionar_persona(mesagem_usuario):
    prompt_sistema = """
    Faça uma análise de mmensagens informada abaixo para identificar se o sentimento é: positivo,
