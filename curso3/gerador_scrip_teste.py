...
def gerar_script_teste(caso_uso, cenario_teste):
    documento_empresa = carrega("documento/acorde_lab.txt")
    ...
    Seu cenário de teste deve fornecer um script em Selenium e deve utilizar o chromium como drove para isso.
    ...
    Crie um script para gerar um teste aautomatizado para ambos.
    """
