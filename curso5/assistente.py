...
class Assistente:
    ...
    def construir_resposta_completa(self, lista_mensages):
    ...
    def avaliar_resultado(self, resultado_avaliado, pergunta):
        ...
        prompt_sistema = """VocÊ é um avaliador de respostas da área de
        computação. Seu objetivo é veriricar se códigos ou sugestões estão
        corretas e indicar, de forma estruturada, os erros e oportunidades de
        melhoria. Dê um parecer da qualidade da solução.
        """
    ...
    def associcar_arquivo(self, caminho_arquivo):
    ...
    def _criar_thread(self, pergunta, caminho_arquivo):
        if self.thread is None:
            self.associcar_arquivo(caminho_arquivo)
